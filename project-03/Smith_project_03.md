...
## 1  2022     2     5          0.02       71       55     63  
## 2  2022     5     9          0          90       71     80.5
## 3  2022     1    13          0          74       59     66.5
## 4  2022     6    10          0.01       91       80     85.5
```
...
``` r
#histogram for good graph
ggplot(new_concrete, aes(x = Water, fill = after_stat(count)))+ geom_histogram() + scale_fill_viridis_c()
```
...
![](Smith_project_03_files/figure-html/unnamed-chunk-15-1.png)<!-- -->
